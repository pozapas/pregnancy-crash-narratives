...
**Tool:** https://narrative-adjudication.vercel.app
**Your access code:** (sent separately) — it sets which coder you are and which rows you get.
**Your file:** `validation_review.csv` — open it in the tool from your own computer.
...
2. **Press Export before closing the tab.** Nothing saves automatically — this is deliberate, so
   that narrative text is never written into your browser's storage. Export whenever you stop.
   Send back the file named `validation_labels_<yourname>.csv`.
